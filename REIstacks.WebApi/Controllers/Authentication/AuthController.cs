...
namespace REIstacks.Api.Controllers.Authentication
{
    [ApiController]
    [Route("api/auth")]
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetCurrentUser()
        {
            try
            {
                ...
                var user = await _unitOfWork.UserProfiles.GetByIdWithOrganizationAsync(Guid.Parse(userId));
        ...
        public async Task<IActionResult> Setup([FromBody] OrganizationSetupRequest request)
        {
            ...
            try
            {
                ...
                var organization = new Domain.Entities.Organizations.Organization
                {
                    Id = organizationId,
