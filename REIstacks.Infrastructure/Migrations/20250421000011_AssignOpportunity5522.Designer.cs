...
namespace REIstacks.Infrastructure.Migrations
{
    ...
    [Migration("20250421000011_AssignOpportunity5522")]
    partial class AssignOpportunity5522
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("REIstacks.Domain.Entities.Properties.PropertyImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("REIstacks.Domain.Entities.CRM.ContactActivity", b =>
                {
                    ...
                    b.HasOne("REIstacks.Domain.Entities.User.UserProfile", "CreatedBy")
                        .WithMany("ContactActivities")
